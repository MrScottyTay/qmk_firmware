...
[_LOWER] = LAYOUT_planck_grid(
    KC_TILD,    KC_HASH, KC_AMPR, KC_PLUS, KC_LCBR, KC_RCBR, _______, KC_NUHS, KC_7, KC_8,   KC_9,    XXXXXXX,
    KC_GRV,     KC_EXLM, KC_AT,   KC_MINS, KC_LPRN, KC_RPRN, _______, KC_EQL,  KC_4, KC_5,   KC_6,    XXXXXXX,
    S(KC_NUHS), KC_DLR,  KC_PERC, KC_ASTR, KC_LBRC, KC_RBRC, KC_CIRC, KC_UNDS, KC_1, KC_2,   KC_3,    XXXXXXX,
